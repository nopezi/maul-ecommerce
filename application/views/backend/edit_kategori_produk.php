            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                        <form class="form-horizontal form-material" action="<?=base_url('admin/aksi_edit_kategori')?>" method="post">
                            <div class="form-group">
                                <label class="col-md-12">Kategori</label>
                                <div class="col-md-12">
                                    <input type="hidden" name="id_kategori" value="<?=$kategori[0]->id_kategori?>">
                                    <input type="text" name="kategori" value="<?=$kategori[0]->kategori?>" class="form-control form-control-line" required> 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Sub Kategori</label>
                                <div class="col-md-12">
                                    <input type="text" name="sub_kategori" data-role="tagsinput" value="<?=$kategori[0]->sub_kategori?>"> 
                                </div>
                            </div>
