<div id="carousel-example-multi3" class="carousel slide carousel-multi-item v-2" data-ride="carousel">
    ...
    <div class="carousel-inner v-2" role="listbox">
        ...
        <div class="col-12 col-md-4">
            <div class="card mb-2">
            <img class="card-img-top" src="https://distrodakwah.id/assets/uploads/featured_image/utama/hd230.jpg"
                alt="Card image cap">
    ...
    <div class="controls-top">
        <a class="btn-floating btn-success" href="#carousel-example-multi3" data-slide="prev"><i
            class="fas fa-chevron-left"></i></a>
        <a href="<?=base_url('home/hoodie')?>" target="_blank" class="btn btn-md btn-success btn-rounded">Selengkapnya</a>
        <a class="btn-floating btn-success" href="#carousel-example-multi3" data-slide="next"><i
